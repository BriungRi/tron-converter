...
function App(): JSX.Element {
  ...
  const convertTronToHex = useCallback((e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    try {
  ...
  const convertHexToTron = useCallback((e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    try {
    ...
    <div className="App">
      ...
      <div className="InputSection">
        <form onSubmit={convertTronToHex}>
          ...
          <input id="tron-address" className="InputField" type="text" ref={tronInput} />
      ...
      <div className="InputSection">
        <form onSubmit={convertHexToTron}>
          ...
          <input id="hex-address" className="InputField" type="text" ref={hexInput} />
          <input className="InputButton" type="submit" value="Convert" />
          <p className="ConversionResult">
